...
CREATE TABLE `solutions` (
  ...
  CONSTRAINT `solutions_ibfk_1` FOREIGN KEY (`parent_question_id`) REFERENCES `questions` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

TRUNCATE `solutions`;
INSERT INTO `solutions` (`id`, `name`, `parent_question_id`, `parent_question_answer`) VALUES
(1,	'chat',	4,	1),
(2,	'dauphin',	4,	0),
(3,	'crocodile',	5,	1),
(4,	'pigeon',	5,	0),
